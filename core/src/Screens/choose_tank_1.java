...
public class choose_tank_1 extends ScreenAdapter implements Screen {
    Texture background;
    Viewport viewport;
    MyGdxGame game;
    ...
    Label Gems;
    float elapsed;
    public choose_tank_1(MyGdxGame g){
    ...
    @Override
    public void show() {
        background = new Texture(Gdx.files.internal("choose_tank_1.jpg"));
...
//
        ...
        plus_coins.setPosition(1540, 980);
        ...
        PLAY.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new play(game, game.database.tank1, game.database.tank1_flip));
            }
